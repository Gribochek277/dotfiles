...
vim.api.nvim_create_autocmd('LspAttach', {
  ...
  callback = function(event)
    ...
    map('<leader>cgd', require('fzf-lua').lsp_definitions, '[G]oto [D]efinition')
    ...
    map('<leader>cd', require('fzf-lua').lsp_type_definitions, 'Type [D]efinition')
...
vim.opt.langmap =
"ФИСВУАПРШОЛДЬТЩЗЙКЫЕГМЦЧНЯ;ABCDEFGHIJKLMNOPQRSTUVWXYZ,фисвуапршольдтщзйкыегмцчня;abcdefghijklmnopqrstuvwxyz"
